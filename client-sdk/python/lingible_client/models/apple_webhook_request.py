...
class AppleWebhookRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["notification_type", "transaction_id", "receipt_data"]

    @field_validator('notification_type')
    def notification_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['INITIAL_BUY', 'CANCEL', 'RENEWAL', 'INTERACTIVE_RENEWAL', 'DID_CHANGE_RENEWAL_PREF', 'DID_CHANGE_RENEWAL_STATUS', 'PRICE_INCREASE_CONSENT', 'REFUND']):
            raise ValueError("must be one of enum values ('INITIAL_BUY', 'CANCEL', 'RENEWAL', 'INTERACTIVE_RENEWAL', 'DID_CHANGE_RENEWAL_PREF', 'DID_CHANGE_RENEWAL_STATUS', 'PRICE_INCREASE_CONSENT', 'REFUND')")
        return value
