...
class UpvoteResponse(BaseModel):
    ...
    UpvoteResponse
    """ # noqa: E501
    submission_id: StrictStr = Field(description="The upvoted submission ID")
    upvotes: Annotated[int, Field(strict=True, ge=0)] = Field(description="Total upvote count after this upvote")
    message: StrictStr = Field(description="Success message")
    __properties: ClassVar[List[str]] = ["submission_id", "upvotes", "message"]
