...
class AdminApprovalResponse(BaseModel):
    ...
    """ # noqa: E501
    submission_id: StrictStr = Field(description="The submission ID")
    status: StrictStr = Field(description="Updated submission status")
    message: StrictStr = Field(description="Success message")
    __properties: ClassVar[List[str]] = ["submission_id", "status", "message"]
