...
class TestQuizAnswerRequest(unittest.TestCase):
    """QuizAnswerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuizAnswerRequest:
        """Test QuizAnswerRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuizAnswerRequest`
        """
        model = QuizAnswerRequest()
        if include_optional:
    ...
    def testQuizAnswerRequest(self):
        """Test QuizAnswerRequest"""
