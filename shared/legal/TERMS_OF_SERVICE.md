...
- Ad-supported free tier with banner and interstitial advertisements
...
### 4.1 Free Tier
- Limited daily translations (specific limits may vary and are subject to change)
- Limited text length per translation (specific limits may vary and are subject to change)
- Access to basic trending terms
- No translation history storage or access
- Display of banner advertisements on all screens
- Display of interstitial advertisements at regular intervals
- Ad interaction tracking for analytics and optimization

### 4.2 Premium Subscription
- Significantly higher daily translation limits
- Increased text length limits per translation
- Translation history storage and access
- Advanced trending features and analytics
- **Completely ad-free experience** with no advertisements displayed
- **No advertising data collection** or sharing with third parties
- Subscription fees are charged through your device's app store

### 4.3 Usage Monitoring and Limits
- We monitor usage to enforce limits and prevent abuse
- Excessive usage may result in temporary or permanent restrictions
- We reserve the right to modify usage limits, features, and service terms at any time
- Changes to limits will be communicated through the app or other appropriate channels
...
- Block, disable, or interfere with advertisements (free users)
- Use ad-blocking software or tools to prevent ad display
- Automatically click or interact with advertisements
- Attempt to manipulate ad delivery or frequency
